...
| 模型测试反馈与图标精修 | ~~`Wiki知识库-model-test-toast-polish/`~~ | ~~`feat/model-test-toast-polish`~~ | ~~`example-wiki-model-test-toast-polish`~~ | ~~8081~~ | ~~`example-wiki-data-model-test-toast-polish`~~ | 已合并入 main |
| 模型配置自动发现 | ~~`Wiki知识库-model-config-discovery/`~~ | ~~`feat/model-config-discovery`~~ | ~~`example-wiki-model-config-discovery`~~ | ~~8081~~ | ~~`example-wiki-data-model-config-discovery`~~ | 已合并入 main |
